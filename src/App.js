...
class App extends Component {
  constructor(props) {
    ...
    this.change_imgShow_bound = this.change_imgShow.bind(this);
  ...
  change_imgShow() {
    this.setState({
      is_imgShow: !this.state.is_imgShow,
    });
  }
  componentDidMount() {
    setInterval(() => {
    ...
    window.addEventListener(
      'popstate',
      this.show_sidebar_bound(null, null, 'clear'),
    );
  }
          ...
          {(token) => (
            <div className="left-container">
              ...
              <Flow
                ...
                token={token.value}
                change_imgShow={this.change_imgShow_bound}
              />
