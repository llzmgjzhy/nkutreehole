...
export function API_VERSION_PARAM() {
    // return '&PKUHelperAPI=3.0&jsapiver='+encodeURIComponent((process.env.REACT_APP_BUILD_INFO||'null')+'-'+(Math.floor(+new Date()/7200)*2));
    return '&jsapiver='+(Math.floor(+new Date()/1000));
}